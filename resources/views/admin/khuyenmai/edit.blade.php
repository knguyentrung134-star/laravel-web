...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="{{ route('admin.khuyenmai.update', $khuyenmai) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="moTaKhuyenMai" 
                               ...
                               value="{{ old('moTaKhuyenMai', $khuyenmai->moTaKhuyenMai) }}" required>
                        @error('moTaKhuyenMai')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="ngayBatDau" 
                                   ...
                                   value="{{ old('ngayBatDau', $khuyenmai->ngayBatDau) }}" required>
                            @error('ngayBatDau')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="ngayKetThuc" 
                                   ...
                                   value="{{ old('ngayKetThuc', $khuyenmai->ngayKetThuc) }}" required>
                            @error('ngayKetThuc')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
